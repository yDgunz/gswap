...
for (var i = 0; i < dom_angle_selectors.length; i++) {
	...
	angle_selectors[das.attr("id")] = new angle_selector(das.attr("id"), das.attr("height"), das.attr("width"), das.attr("angle1"), das.attr("angle2"), das.attr("radius"), das.attr("handle_radius"), das.attr("ccw"), das.attr("angle1_label"), das.attr("angle2_label"));
